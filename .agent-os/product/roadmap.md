...
- [x] JSON-RPC over HTTP with basic authentication (API key)
- [x] Core tool implementations: `tui.start`, `tui.send_keys`, `tui.read_frame`, `tui.close`
- [x] Request/response schema validation and error handling
...
- [x] Basic logging and error reporting
